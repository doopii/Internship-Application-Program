...
public static void bubbleSort(DoublyListInterface<Applicant> list, String by, boolean ascending) {
                ...
                switch (by) {
                    case "id":
                        shouldSwap = ascending
                            ? a1.getApplicantID().compareTo(a2.getApplicantID()) > 0
                            : a1.getApplicantID().compareTo(a2.getApplicantID()) < 0;
                        break;
                    case "name":
                        shouldSwap = ascending
                            ? a1.getApplicantName().compareToIgnoreCase(a2.getApplicantName()) > 0
                            : a1.getApplicantName().compareToIgnoreCase(a2.getApplicantName()) < 0;
                        break;
                    case "cgpa":
                        shouldSwap = ascending
                            ? a1.getCgpa() > a2.getCgpa()
                            : a1.getCgpa() < a2.getCgpa();
                        break;
                }
