...
public class InitialiserJava {
    DoublyListInterface<Skill> skillList = initializeSkills();  // Assume this method returns the skill list
    ...
    public DoublyListInterface<Applicant> initializeApplicants() {
        ...
        applicantList.add(new Applicant("A001", "Gary Tee","0128273661","gary@gmail.com", skillList, jobDesiredList));
